...
Note: Do not use class member/global/static variables to store states. Your serialize and deserialize competitiveProgramming.archive.algorithms should be stateless.
 */
